    ...
    cart.forEach(item => {
        ...
        html += `
            <div class="cart-item d-flex flex-wrap align-items-center">
                <div class="bg-light rounded p-2 me-3 d-none d-md-block" style="width: 80px; height: 80px; display: flex; align-items: center; justify-content: center; font-size: 2rem;">
                ...
                <div class="d-flex align-items-center my-2 my-sm-0 mx-sm-3 order-3 order-sm-2">
                ...
                <div class="text-end ms-auto order-2 order-sm-3" style="min-width: 80px;">
                    <div class="fw-bold fs-5 mb-1">₹${itemTotal}</div>
                    <button class="btn btn-sm btn-link text-danger p-0 text-decoration-none" onclick="removeItem(${item.id})">
